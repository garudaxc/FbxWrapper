...
public class FbxQueryClassId : FbxQuery {
  ...
  internal FbxQueryClassId(global::System.IntPtr cPtr, bool cMemoryOwn) : base(fbx_wrapperPINVOKE.FbxQueryClassId_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fbx_wrapperPINVOKE.delete_FbxQueryClassId(swigCPtr);
        }
  ...
  public static FbxQueryClassId Create(FbxClassId pClassId) {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxQueryClassId_Create(FbxClassId.getCPtr(pClassId));
  ...
  public override int GetUniqueId() {
    int ret = fbx_wrapperPINVOKE.FbxQueryClassId_GetUniqueId(swigCPtr);
    return ret;
  }
  ...
  public override bool IsEqual(FbxQuery pOtherQuery) {
    bool ret = fbx_wrapperPINVOKE.FbxQueryClassId_IsEqual(swigCPtr, FbxQuery.getCPtr(pOtherQuery));
    return ret;
  }
