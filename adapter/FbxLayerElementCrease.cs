...
public class FbxLayerElementCrease : FbxLayerElementTemplateFbxDouble {
  ...
  internal FbxLayerElementCrease(global::System.IntPtr cPtr, bool cMemoryOwn) : base(fbx_wrapperPINVOKE.FbxLayerElementCrease_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fbx_wrapperPINVOKE.delete_FbxLayerElementCrease(swigCPtr);
        }
