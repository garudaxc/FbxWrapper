...
public class FbxSelectionSet : FbxCollection {
  ...
  internal FbxSelectionSet(global::System.IntPtr cPtr, bool cMemoryOwn) : base(fbx_wrapperPINVOKE.FbxSelectionSet_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public static FbxClassId ClassId {
    set {
      fbx_wrapperPINVOKE.FbxSelectionSet_ClassId_set(FbxClassId.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxSelectionSet_ClassId_get();
  ...
  public override FbxClassId GetClassId() {
    FbxClassId ret = new FbxClassId(fbx_wrapperPINVOKE.FbxSelectionSet_GetClassId(swigCPtr), true);
    return ret;
  }

  public new static FbxSelectionSet Create(FbxManager pManager, string pName) {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxSelectionSet_Create__SWIG_0(FbxManager.getCPtr(pManager), pName);
  ...
  public SWIGTYPE_p_FbxPropertyTT_FbxString_t SelectionSetAnnotation {
    set {
      fbx_wrapperPINVOKE.FbxSelectionSet_SelectionSetAnnotation_set(swigCPtr, SWIGTYPE_p_FbxPropertyTT_FbxString_t.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxSelectionSet_SelectionSetAnnotation_get(swigCPtr);
  ...
  public void GetFaceSelection(FbxObject pObj, SWIGTYPE_p_FbxArrayT_int_t pPolygonIndexArray) {
    fbx_wrapperPINVOKE.FbxSelectionSet_GetFaceSelection(swigCPtr, FbxObject.getCPtr(pObj), SWIGTYPE_p_FbxArrayT_int_t.getCPtr(pPolygonIndexArray));
  ...
  public void GetVertexSelection(FbxObject pObj, SWIGTYPE_p_FbxArrayT_int_t pVertexIndexArray) {
    fbx_wrapperPINVOKE.FbxSelectionSet_GetVertexSelection(swigCPtr, FbxObject.getCPtr(pObj), SWIGTYPE_p_FbxArrayT_int_t.getCPtr(pVertexIndexArray));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
  }
