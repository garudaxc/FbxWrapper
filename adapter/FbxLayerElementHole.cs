...
public class FbxLayerElementHole : FbxLayerElementTemplateFbxBool {
  ...
  internal FbxLayerElementHole(global::System.IntPtr cPtr, bool cMemoryOwn) : base(fbx_wrapperPINVOKE.FbxLayerElementHole_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fbx_wrapperPINVOKE.delete_FbxLayerElementHole(swigCPtr);
        }
  ...
  public new void SetReferenceMode(FbxLayerElement.EReferenceMode pMode) {
    fbx_wrapperPINVOKE.FbxLayerElementHole_SetReferenceMode(swigCPtr, (int)pMode);
  }
