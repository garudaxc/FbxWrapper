...
public class FbxIOSettings : FbxObject {
  ...
  public static FbxClassId ClassId {
    set {
      fbx_wrapperPINVOKE.FbxIOSettings_ClassId_set(FbxClassId.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxIOSettings_ClassId_get();
  ...
  public override FbxClassId GetClassId() {
    FbxClassId ret = new FbxClassId(fbx_wrapperPINVOKE.FbxIOSettings_GetClassId(swigCPtr), true);
    return ret;
  }
  ...
  public FbxProperty AddPropertyGroup(string pName, FbxDataType pDataType, string pLabel) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddPropertyGroup__SWIG_0(swigCPtr, pName, FbxDataType.getCPtr(pDataType), pLabel), true);
  ...
  public FbxProperty AddPropertyGroup(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel, bool pVisible, bool pSavable, bool pEnabled) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddPropertyGroup__SWIG_3(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel, pVisible, pSavable, pEnabled), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public FbxProperty AddPropertyGroup(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel, bool pVisible, bool pSavable) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddPropertyGroup__SWIG_4(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel, pVisible, pSavable), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public FbxProperty AddPropertyGroup(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddPropertyGroup__SWIG_6(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public FbxProperty AddPropertyGroup(FbxProperty pParentProperty, string pName, FbxDataType pDataType) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddPropertyGroup__SWIG_7(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType)), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public FbxProperty AddProperty(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel, SWIGTYPE_p_void pValue, bool pVisible, bool pSavable) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddProperty__SWIG_1(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel, SWIGTYPE_p_void.getCPtr(pValue), pVisible, pSavable), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public FbxProperty AddProperty(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel, SWIGTYPE_p_void pValue, bool pVisible) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddProperty__SWIG_2(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel, SWIGTYPE_p_void.getCPtr(pValue), pVisible), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public FbxProperty AddProperty(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel, SWIGTYPE_p_void pValue) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddProperty__SWIG_3(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel, SWIGTYPE_p_void.getCPtr(pValue)), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public FbxProperty AddProperty(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddProperty__SWIG_4(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public FbxProperty AddProperty(FbxProperty pParentProperty, string pName, FbxDataType pDataType) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddProperty__SWIG_5(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType)), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public FbxProperty AddPropertyMinMax(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel, SWIGTYPE_p_void pValue, SWIGTYPE_p_double pMinValue, SWIGTYPE_p_double pMaxValue, bool pVisible) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddPropertyMinMax__SWIG_2(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel, SWIGTYPE_p_void.getCPtr(pValue), SWIGTYPE_p_double.getCPtr(pMinValue), SWIGTYPE_p_double.getCPtr(pMaxValue), pVisible), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public FbxProperty AddPropertyMinMax(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel, SWIGTYPE_p_void pValue, SWIGTYPE_p_double pMinValue, SWIGTYPE_p_double pMaxValue) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddPropertyMinMax__SWIG_3(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel, SWIGTYPE_p_void.getCPtr(pValue), SWIGTYPE_p_double.getCPtr(pMinValue), SWIGTYPE_p_double.getCPtr(pMaxValue)), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public FbxProperty AddPropertyMinMax(FbxProperty pParentProperty, string pName, FbxDataType pDataType, string pLabel) {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxIOSettings_AddPropertyMinMax__SWIG_6(swigCPtr, FbxProperty.getCPtr(pParentProperty), pName, FbxDataType.getCPtr(pDataType), pLabel), true);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
