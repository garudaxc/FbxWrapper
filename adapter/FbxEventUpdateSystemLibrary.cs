...
public class FbxEventUpdateSystemLibrary : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fbx_wrapperPINVOKE.delete_FbxEventUpdateSystemLibrary(swigCPtr);
        }
  ...
  public virtual string GetEventName() {
    string ret = fbx_wrapperPINVOKE.FbxEventUpdateSystemLibrary_GetEventName(swigCPtr);
    return ret;
  }
  ...
  public FbxLibrary GetLibrary() {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxEventUpdateSystemLibrary_GetLibrary(swigCPtr);
