...
public class FbxDocument : FbxCollection {
  ...
  public static FbxClassId ClassId {
    set {
      fbx_wrapperPINVOKE.FbxDocument_ClassId_set(FbxClassId.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxDocument_ClassId_get();
  ...
  public FbxPropertyTReference Roots {
    set {
      fbx_wrapperPINVOKE.FbxDocument_Roots_set(swigCPtr, FbxPropertyTReference.getCPtr(value));
    } 
    get {
  ...
  public FbxObject GetRootMember(FbxCriteria pCriteria, int pIndex) {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxDocument_GetRootMember__SWIG_4(swigCPtr, FbxCriteria.getCPtr(pCriteria), pIndex);
    FbxObject ret = (cPtr == global::System.IntPtr.Zero) ? null : new FbxObject(cPtr, false);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public int UnloadContent(FbxStatus pStatus) {
    int ret = fbx_wrapperPINVOKE.FbxDocument_UnloadContent__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }
