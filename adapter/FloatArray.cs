...
public class FloatArray : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fbx_wrapperPINVOKE.delete_FloatArray(swigCPtr);
        }
  ...
  public FloatArray(int nelements) : this(fbx_wrapperPINVOKE.new_FloatArray(nelements), true) {
  }

  public float getitem(int index) {
    float ret = fbx_wrapperPINVOKE.FloatArray_getitem(swigCPtr, index);
    return ret;
  }

  public void setitem(int index, float value) {
    fbx_wrapperPINVOKE.FloatArray_setitem(swigCPtr, index, value);
  }

  public SWIGTYPE_p_float cast() {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FloatArray_cast(swigCPtr);
