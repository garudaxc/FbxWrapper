...
public class FbxPose : FbxObject {
  ...
  internal FbxPose(global::System.IntPtr cPtr, bool cMemoryOwn) : base(fbx_wrapperPINVOKE.FbxPose_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public static FbxClassId ClassId {
    set {
      fbx_wrapperPINVOKE.FbxPose_ClassId_set(FbxClassId.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxPose_ClassId_get();
  ...
  public override FbxClassId GetClassId() {
    FbxClassId ret = new FbxClassId(fbx_wrapperPINVOKE.FbxPose_GetClassId(swigCPtr), true);
    return ret;
  }
  ...
  public new static FbxPose Create(FbxObject pContainer, string pName) {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxPose_Create__SWIG_1(FbxObject.getCPtr(pContainer), pName);
    FbxPose ret = (cPtr == global::System.IntPtr.Zero) ? null : new FbxPose(cPtr, false);
    return ret;
  }

  public void SetIsBindPose(bool pIsBindPose) {
    fbx_wrapperPINVOKE.FbxPose_SetIsBindPose(swigCPtr, pIsBindPose);
  }

  public bool IsBindPose() {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsBindPose(swigCPtr);
    return ret;
  }

  public bool IsRestPose() {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsRestPose(swigCPtr);
    return ret;
  }

  public int GetCount() {
    int ret = fbx_wrapperPINVOKE.FbxPose_GetCount(swigCPtr);
    return ret;
  }

  public int Add(FbxNode pNode, FbxMatrix pMatrix, bool pLocalMatrix, bool pMultipleBindPose) {
    int ret = fbx_wrapperPINVOKE.FbxPose_Add__SWIG_0(swigCPtr, FbxNode.getCPtr(pNode), FbxMatrix.getCPtr(pMatrix), pLocalMatrix, pMultipleBindPose);
  ...
  public int Add(FbxNode pNode, FbxMatrix pMatrix) {
    int ret = fbx_wrapperPINVOKE.FbxPose_Add__SWIG_2(swigCPtr, FbxNode.getCPtr(pNode), FbxMatrix.getCPtr(pMatrix));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Remove(int pIndex) {
    fbx_wrapperPINVOKE.FbxPose_Remove(swigCPtr, pIndex);
  }

  public FbxNameHandler GetNodeName(int pIndex) {
    FbxNameHandler ret = new FbxNameHandler(fbx_wrapperPINVOKE.FbxPose_GetNodeName(swigCPtr, pIndex), true);
    return ret;
  }

  public FbxNode GetNode(int pIndex) {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxPose_GetNode(swigCPtr, pIndex);
    FbxNode ret = (cPtr == global::System.IntPtr.Zero) ? null : new FbxNode(cPtr, false);
    return ret;
  }

  public FbxMatrix GetMatrix(int pIndex) {
    FbxMatrix ret = new FbxMatrix(fbx_wrapperPINVOKE.FbxPose_GetMatrix(swigCPtr, pIndex), false);
    return ret;
  }

  public bool IsLocalMatrix(int pIndex) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsLocalMatrix(swigCPtr, pIndex);
    return ret;
  }

  public int Find(FbxNameHandler pNodeName, char pCompareWhat) {
    int ret = fbx_wrapperPINVOKE.FbxPose_Find__SWIG_0(swigCPtr, FbxNameHandler.getCPtr(pNodeName), pCompareWhat);
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int Find(FbxNameHandler pNodeName) {
    int ret = fbx_wrapperPINVOKE.FbxPose_Find__SWIG_1(swigCPtr, FbxNameHandler.getCPtr(pNodeName));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int Find(FbxNode pNode) {
    int ret = fbx_wrapperPINVOKE.FbxPose_Find__SWIG_2(swigCPtr, FbxNode.getCPtr(pNode));
    return ret;
  }
  ...
  public static bool GetPosesContaining(FbxManager pManager, FbxNode pNode, SWIGTYPE_p_FbxArrayT_FbxPose_p_t pPoseList, SWIGTYPE_p_FbxArrayT_int_t pIndex) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_GetPosesContaining__SWIG_0(FbxManager.getCPtr(pManager), FbxNode.getCPtr(pNode), SWIGTYPE_p_FbxArrayT_FbxPose_p_t.getCPtr(pPoseList), SWIGTYPE_p_FbxArrayT_int_t.getCPtr(pIndex));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static bool GetPosesContaining(FbxScene pScene, FbxNode pNode, SWIGTYPE_p_FbxArrayT_FbxPose_p_t pPoseList, SWIGTYPE_p_FbxArrayT_int_t pIndex) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_GetPosesContaining__SWIG_1(FbxScene.getCPtr(pScene), FbxNode.getCPtr(pNode), SWIGTYPE_p_FbxArrayT_FbxPose_p_t.getCPtr(pPoseList), SWIGTYPE_p_FbxArrayT_int_t.getCPtr(pIndex));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static bool GetBindPoseContaining(FbxManager pManager, FbxNode pNode, SWIGTYPE_p_FbxArrayT_FbxPose_p_t pPoseList, SWIGTYPE_p_FbxArrayT_int_t pIndex) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_GetBindPoseContaining__SWIG_0(FbxManager.getCPtr(pManager), FbxNode.getCPtr(pNode), SWIGTYPE_p_FbxArrayT_FbxPose_p_t.getCPtr(pPoseList), SWIGTYPE_p_FbxArrayT_int_t.getCPtr(pIndex));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static bool GetBindPoseContaining(FbxScene pScene, FbxNode pNode, SWIGTYPE_p_FbxArrayT_FbxPose_p_t pPoseList, SWIGTYPE_p_FbxArrayT_int_t pIndex) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_GetBindPoseContaining__SWIG_1(FbxScene.getCPtr(pScene), FbxNode.getCPtr(pNode), SWIGTYPE_p_FbxArrayT_FbxPose_p_t.getCPtr(pPoseList), SWIGTYPE_p_FbxArrayT_int_t.getCPtr(pIndex));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool IsValidBindPose(FbxNode pRoot, double pMatrixCmpTolerance, FbxStatus pStatus) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsValidBindPose__SWIG_0(swigCPtr, FbxNode.getCPtr(pRoot), pMatrixCmpTolerance, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public bool IsValidBindPose(FbxNode pRoot, double pMatrixCmpTolerance) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsValidBindPose__SWIG_1(swigCPtr, FbxNode.getCPtr(pRoot), pMatrixCmpTolerance);
    return ret;
  }

  public bool IsValidBindPose(FbxNode pRoot) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsValidBindPose__SWIG_2(swigCPtr, FbxNode.getCPtr(pRoot));
    return ret;
  }
  ...
  public bool IsValidBindPoseVerbose(FbxNode pRoot, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pMissingAncestors, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pMissingDeformers, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pMissingDeformersAncestors, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pWrongMatrices, double pMatrixCmpTolerance, FbxStatus pStatus) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsValidBindPoseVerbose__SWIG_0(swigCPtr, FbxNode.getCPtr(pRoot), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pMissingAncestors), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pMissingDeformers), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pMissingDeformersAncestors), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pWrongMatrices), pMatrixCmpTolerance, FbxStatus.getCPtr(pStatus));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool IsValidBindPoseVerbose(FbxNode pRoot, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pMissingAncestors, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pMissingDeformers, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pMissingDeformersAncestors, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pWrongMatrices) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsValidBindPoseVerbose__SWIG_2(swigCPtr, FbxNode.getCPtr(pRoot), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pMissingAncestors), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pMissingDeformers), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pMissingDeformersAncestors), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pWrongMatrices));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool IsValidBindPoseVerbose(FbxNode pRoot, FbxUserNotification pUserNotification, double pMatrixCmpTolerance) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsValidBindPoseVerbose__SWIG_4(swigCPtr, FbxNode.getCPtr(pRoot), FbxUserNotification.getCPtr(pUserNotification), pMatrixCmpTolerance);
    return ret;
  }

  public bool IsValidBindPoseVerbose(FbxNode pRoot, FbxUserNotification pUserNotification) {
    bool ret = fbx_wrapperPINVOKE.FbxPose_IsValidBindPoseVerbose__SWIG_5(swigCPtr, FbxNode.getCPtr(pRoot), FbxUserNotification.getCPtr(pUserNotification));
    return ret;
  }
