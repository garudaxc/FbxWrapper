...
public class FbxEventPopulateSystemLibrary : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fbx_wrapperPINVOKE.delete_FbxEventPopulateSystemLibrary(swigCPtr);
        }
  ...
  public virtual string GetEventName() {
    string ret = fbx_wrapperPINVOKE.FbxEventPopulateSystemLibrary_GetEventName(swigCPtr);
    return ret;
  }

  public FbxEventPopulateSystemLibrary(FbxLibrary pLibrary) : this(fbx_wrapperPINVOKE.new_FbxEventPopulateSystemLibrary(FbxLibrary.getCPtr(pLibrary)), true) {
  }

  public FbxLibrary GetLibrary() {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxEventPopulateSystemLibrary_GetLibrary(swigCPtr);
