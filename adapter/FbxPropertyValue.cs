...
public class FbxPropertyValue : global::System.IDisposable {
  ...
  public void Destroy() {
    fbx_wrapperPINVOKE.FbxPropertyValue_Destroy(swigCPtr);
  }
  ...
  public bool Get(SWIGTYPE_p_void pValue, EFbxType pValueType) {
    bool ret = fbx_wrapperPINVOKE.FbxPropertyValue_Get(swigCPtr, SWIGTYPE_p_void.getCPtr(pValue), (int)pValueType);
    return ret;
  }
  ...
  public uint GetSizeOf() {
    uint ret = fbx_wrapperPINVOKE.FbxPropertyValue_GetSizeOf(swigCPtr);
    return ret;
  }

  public uint GetComponentCount() {
    uint ret = fbx_wrapperPINVOKE.FbxPropertyValue_GetComponentCount(swigCPtr);
    return ret;
  }

  public void IncRef() {
    fbx_wrapperPINVOKE.FbxPropertyValue_IncRef(swigCPtr);
  }

  public void DecRef() {
    fbx_wrapperPINVOKE.FbxPropertyValue_DecRef(swigCPtr);
  }

  public int GetRef() {
    int ret = fbx_wrapperPINVOKE.FbxPropertyValue_GetRef(swigCPtr);
    return ret;
  }

  public FbxPropertyValue() : this(fbx_wrapperPINVOKE.new_FbxPropertyValue(), true) {
  }
