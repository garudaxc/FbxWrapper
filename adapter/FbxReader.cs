...
public class FbxReader : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fbx_wrapperPINVOKE.delete_FbxReader(swigCPtr);
        }
  ...
  public virtual void GetVersion(SWIGTYPE_p_int pMajor, SWIGTYPE_p_int pMinor, SWIGTYPE_p_int pRevision) {
    fbx_wrapperPINVOKE.FbxReader_GetVersion(swigCPtr, SWIGTYPE_p_int.getCPtr(pMajor), SWIGTYPE_p_int.getCPtr(pMinor), SWIGTYPE_p_int.getCPtr(pRevision));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual bool FileOpen(string pFileName) {
    bool ret = fbx_wrapperPINVOKE.FbxReader_FileOpen__SWIG_0(swigCPtr, pFileName);
    return ret;
  }
  ...
  public virtual bool FileClose() {
    bool ret = fbx_wrapperPINVOKE.FbxReader_FileClose(swigCPtr);
    return ret;
  }

  public virtual bool IsFileOpen() {
    bool ret = fbx_wrapperPINVOKE.FbxReader_IsFileOpen(swigCPtr);
    return ret;
  }

  public virtual bool GetReadOptions(bool pParseFileAsNeeded) {
    bool ret = fbx_wrapperPINVOKE.FbxReader_GetReadOptions__SWIG_0(swigCPtr, pParseFileAsNeeded);
    return ret;
  }

  public virtual bool GetReadOptions() {
    bool ret = fbx_wrapperPINVOKE.FbxReader_GetReadOptions__SWIG_1(swigCPtr);
    return ret;
  }
  ...
  public virtual void PluginReadParameters(FbxObject pParams) {
    fbx_wrapperPINVOKE.FbxReader_PluginReadParameters(swigCPtr, FbxObject.getCPtr(pParams));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual bool FileOpen(string pFileName, FbxReader.EFileOpenSpecialFlags arg1) {
    bool ret = fbx_wrapperPINVOKE.FbxReader_FileOpen__SWIG_2(swigCPtr, pFileName, (int)arg1);
    return ret;
  }
  ...
  public virtual SWIGTYPE_p_FbxArrayT_FbxTakeInfo_p_t GetTakeInfo() {
    global::System.IntPtr cPtr = fbx_wrapperPINVOKE.FbxReader_GetTakeInfo(swigCPtr);
  ...
  public virtual bool GetDefaultRenderResolution(FbxString pCamName, FbxString pResolutionMode, SWIGTYPE_p_double pW, SWIGTYPE_p_double pH) {
    bool ret = fbx_wrapperPINVOKE.FbxReader_GetDefaultRenderResolution(swigCPtr, FbxString.getCPtr(pCamName), FbxString.getCPtr(pResolutionMode), SWIGTYPE_p_double.getCPtr(pW), SWIGTYPE_p_double.getCPtr(pH));
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool IsGenuine() {
    bool ret = fbx_wrapperPINVOKE.FbxReader_IsGenuine(swigCPtr);
    return ret;
  }
  ...
  public virtual void SetProgressHandler(FbxProgress arg0) {
    fbx_wrapperPINVOKE.FbxReader_SetProgressHandler(swigCPtr, FbxProgress.getCPtr(arg0));
  }

  public virtual void SetEmbeddingExtractionFolder(string arg0) {
    fbx_wrapperPINVOKE.FbxReader_SetEmbeddingExtractionFolder(swigCPtr, arg0);
  }

  public virtual bool SupportsStreams() {
    bool ret = fbx_wrapperPINVOKE.FbxReader_SupportsStreams(swigCPtr);
    return ret;
  }
