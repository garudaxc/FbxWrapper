...
public class FbxConnectEvent : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fbx_wrapperPINVOKE.delete_FbxConnectEvent(swigCPtr);
        }
  ...
  public FbxConnectEvent.EDirection GetDirection() {
    FbxConnectEvent.EDirection ret = (FbxConnectEvent.EDirection)fbx_wrapperPINVOKE.FbxConnectEvent_GetDirection(swigCPtr);
    return ret;
  }

  public FbxProperty GetSrc() {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxConnectEvent_GetSrc(swigCPtr), false);
    return ret;
  }

  public FbxProperty GetDst() {
    FbxProperty ret = new FbxProperty(fbx_wrapperPINVOKE.FbxConnectEvent_GetDst(swigCPtr), false);
    return ret;
  }
