...
%template(DirectArrayFbxInt)FbxLayerElementArrayTemplate<int>;
%template(DirectArrayFbxDouble)FbxLayerElementArrayTemplate<double>;
%template(DirectArrayFbxBool)FbxLayerElementArrayTemplate<bool>;
%template(DirectArrayFbxVoidPtr)FbxLayerElementArrayTemplate<void*>;
%template(DirectArrayFbxVector2)FbxLayerElementArrayTemplate<FbxVector2>;
%template(DirectArrayFbxVector4)FbxLayerElementArrayTemplate<FbxVector4>;
%template(DirectArrayFbxColor)FbxLayerElementArrayTemplate<FbxColor>;
%template(DirectArrayFbxSurfaceMaterialPtr)FbxLayerElementArrayTemplate<FbxSurfaceMaterial*>;
%template(DirectArrayFbxTexturePtr)FbxLayerElementArrayTemplate<FbxTexture*>;
