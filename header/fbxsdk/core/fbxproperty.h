...
#if defined SWIG
%template(FbxPropertyTDouble)FbxPropertyT<FbxDouble>;
%template(FbxPropertyTBool)FbxPropertyT<FbxBool>;
%template(FbxPropertyTReference)FbxPropertyT<FbxReference>;
%template(FbxPropertyTERotationOrder)FbxPropertyT<EFbxRotationOrder>;
%template(FbxPropertyTEQuatInterpMode)FbxPropertyT<EFbxQuatInterpMode>;

%template(FbxPropertyTDouble3)FbxPropertyT<FbxDouble3>;
#endif
